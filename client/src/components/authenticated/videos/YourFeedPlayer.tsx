...
const YourFeedPlayer: React.FC<Props> = ({ stream }) => {
    ...
    return (
        <div className="relative w-[50vw] h-[65vh]  overflow-hidden rounded-lg shadow-md bg-black ">
            <video
                ref={videoRef}
